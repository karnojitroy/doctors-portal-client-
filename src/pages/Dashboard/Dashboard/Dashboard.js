    ...
    const drawer = (
        <div>
            ...
            <Link to="/appointment" style={{ color: "white", textDecoration: "none" }} >
                <Button color="primary">Appointment</Button>
            </Link>
            <Divider />
            ...
            {admin &&
                <Box>
                    ...
                    <Divider />
                    <Link to={`${url}/addDoctor`} style={{ color: "white", textDecoration: "none" }} >
        ...
        <Box sx={{ display: 'flex' }}>
            ...
            >
                <Toolbar>
                    ...
                    <Typography variant="h6" noWrap component="div">{admin ? 'Admin Dashboard' : 'User Dashboard'}
